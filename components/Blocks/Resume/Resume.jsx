      ...
      <Container>
        <div className={styles.content}>
          <div className={styles.cardGroup} ref={cardGroup}>
            <div className={`${styles.card} ${styles.cardV1}`}>
              <div className={styles.cardInner}>
                <div className={styles.cardTitle}>Dr.Proton</div>
                <div className={styles.cardDesc}>Tech & Solutions</div>
                <hr />
                <p>
                  We are, a Tech & Solutions a company with over 2 years of
                  professional experience. Successfully building user-friendly
                  websites with ReactJS & NextJS. I pay attention to small
                  details, enjoy technical problems, and work well in teams. I
                  like learning new technologies and always aim to improve my
                  skills.
                </p>
                <div>
                  <Link
          ...
          <div className={styles.links}>
            ...
            <Link href={`${commonConfig.social.codepen}`} target={"_blank"}>
              CodePen
            </Link>
          </div>
        </div>
